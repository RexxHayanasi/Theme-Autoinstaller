...
# Unduh file tema
wget -O /root/stellar.zip https://github.com/veryLinh/Theme-Autoinstaller/raw/main/stellar.zip
...
while true; do
  ...
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : RexxHayanasi ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by RexxHayanasi ${NC}"
